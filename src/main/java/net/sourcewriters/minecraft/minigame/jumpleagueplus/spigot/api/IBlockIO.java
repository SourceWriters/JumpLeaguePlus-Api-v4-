...
public interface IBlockIO {
    ...
    IParkourBlock load(DataInput input) throws IOException, IllegalArgumentException;
    
    void save(IParkourBlock block, DataOutput output) throws IOException, IllegalArgumentException;
