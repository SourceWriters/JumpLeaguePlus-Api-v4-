...
public class JumpLeaguePlayerParkourEndCustomLootGeneratedEvent extends JumpLeaguePlayerParkourEvent {

    private static final HandlerList HANDLERS = new HandlerList();

    private final List<ItemStack> items;

    public JumpLeaguePlayerParkourEndCustomLootGeneratedEvent(@NonNull IJumpLeaguePlusSpigotApi api, @NonNull Player player,
